...
?>
  ...
  <div class= " content-header " >
            ...
            <h1 class="font-bold ">Bienvenue sur <span class="green-score ">Green Score</span>!</h1>
    
            <p class="w-1/2 h-full">Nous sommes dédiée à aider les individus et les petites entreprises à évaluer leur impact sur l'environnement
                en
                calculant leur empreinte carbone annuelle.</p>
            <div>
                <span>un geste à la fois</span>
                <a href="">Commencer</a>
  </div>
...
<main>
    <div class="flex">
        ...
        <div>
            ...
            <a href="">Calculer mon empreinte carbone</a>
        </div>
    </div>
</main>
<?php
